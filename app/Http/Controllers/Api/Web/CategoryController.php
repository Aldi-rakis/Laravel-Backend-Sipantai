...
class CategoryController extends Controller
{
    ...
    {
        //get categories
         // Get categories with their places
    $categories = Category::with('places', 'places.images')->latest()->get();
    
    // Return with Api Resource
    return new CategoryResource(true, 'List Data Categories with Places', $categories);
